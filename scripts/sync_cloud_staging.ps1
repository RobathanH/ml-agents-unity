...
# 10-minute scheduled task indefinitely -- kill any sync older than 15 min.
Get-CimInstance Win32_Process -Filter "Name='powershell.exe'" -ErrorAction SilentlyContinue |
    Where-Object { $_.CommandLine -match "sync_cloud_staging" -and $_.ProcessId -ne $PID -and
                   ((Get-Date) - $_.CreationDate).TotalMinutes -gt 15 } |
